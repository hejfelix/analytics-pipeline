...
object analytics extends ScalaModule {
    ...
    override def forkArgs: Target[Seq[String]] =
      Seq("-Dlog4j.configuration=log4j.properties")

    override def scalacPluginIvyDeps: Target[Loose.Agg[Dep]] =
      Agg(ivy"org.scalamacros:paradise_2.11.12:2.1.1")

    def scalaVersion: Target[String] = scala211
...
//    "-Ywarn-unused:privates",            // Warn if a private member is unused.
    ...
    override def ivyDeps: Target[Loose.Agg[Dep]] = Agg(
      ...
      ivy"io.circe::circe-parser:${V.circe}",
      ivy"io.circe::circe-java8:${V.circe}",
      ivy"org.apache.spark:spark-streaming-kafka-0-10_2.11:${V.spark}"
    )
